...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //ET 10/16/14 - set preferredContentSize so actionSheet presentation (iPad) does not
    // collapse popover
    assetsCollectionViewController.preferredContentSize = self.view.frame.size;
